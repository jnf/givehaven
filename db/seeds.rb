...
projects = [
  ...
  {
    organization_id: 1, title: "test 1", description: 'description', image:  File.open(File.join('app/assets/images/seeds/resume.jpg')), project_approval: 'approved', funding_status: 'not funded', shipping_status: 'pending', total_requested: 400, total_remaining: 400, total_donated: 0, organization_details: 'details', project_details: 'project_details', expires_on: "Tue, 26 Jan 2016 18:12:19 -0700"
  },
  {
    organization_id: 2, title: "test 2", description: 'description', image:  File.open(File.join('app/assets/images/seeds/razors.jpg')), project_approval: 'approved', funding_status: 'not funded', shipping_status: 'pending', total_requested: 400, total_remaining: 400, total_donated: 0, organization_details: 'details', project_details: 'project_details', expires_on: "Tue, 26 Jan 2016 18:12:19 -0700"
  },
  {
    organization_id: 1, title: "test 3", description: 'description', image:  File.open(File.join('app/assets/images/seeds/feminine.jpg')), project_approval: 'approved', funding_status: 'not funded', shipping_status: 'pending', total_requested: 400, total_remaining: 400, total_donated: 0, organization_details: 'details', project_details: 'project_details', expires_on: "Tue, 26 Jan 2016 18:12:19 -0700"
  }
]
