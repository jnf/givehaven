...
projects = [
  {
    organization_id: 1, title: "Oral Hygiene for Youth in Need", description: "oral hygiene", project_approval: "approved", funding_status: "not funded", shipping_status: "shipped", image: File.open(File.join('app/assets/images/seeds/oral-hygiene.jpg')), total_requested: 1025, total_donated: 430, total_remaining: 595, organization_details: 'ROOTS provides shelter and other essential services to homeless young adults.  We build community, advocate for social justice, and foster dignity among low-income people. Over the last 5 years, ROOTS Young Adult Shelter has seen an enormous increase in the number of times homeless youth have been turned away because of a lack of space. These young people are spiraling out of the foster care system and onto the streets, fleeing abusive homes and failing to find work opportunities to survive in this tough economic climate. ROOTS was the first overnight shelter in the city specifically designed to meet the needs of homeless young adults, and is one of the only co-ed shelters in the city, providing an integral piece of the continuum of care for homeless persons in King County. We mark as our most significant accomplishment that for over eight years, RYAS has operated seven nights per week without ever once having closed due to lack of staffing or volunteers.', project_details: 'Mornings are the most important part of our day. We try our hardest to start our youth out on the right foot. That means a healthy breakfast, warm clothes and a hot shower. We are in desperate need of toothbrushes and toothpaste. These products will be used by the teens staying with and visiting us.', expires_on: "Tue, 26 Jan 2016 18:12:19 -0700"
  },
  {
    organization_id: 2, title: "winter warmth", description: "winter warmth", project_approval: "approved", funding_status: "funded", shipping_status: "pending", total_requested: 1200, total_remaining: 0, total_donated: 1200, organization_details: 'we do stuff', project_details: "winter warmth", expires_on: "Tue, 26 Jan 2016 18:12:19 -0700"
  },
  {
    organization_id: 1, title: "test 1", description: 'description', project_approval: 'approved', funding_status: 'not funded', shipping_status: 'pending', total_requested: 400, total_remaining: 400, total_donated: 0, organization_details: 'details', project_details: 'project_details', expires_on: "Tue, 26 Jan 2016 18:12:19 -0700"
  },
  {
    organization_id: 2, title: "test 2", description: 'description', project_approval: 'approved', funding_status: 'not funded', shipping_status: 'pending', total_requested: 400, total_remaining: 400, total_donated: 0, organization_details: 'details', project_details: 'project_details', expires_on: "Tue, 26 Jan 2016 18:12:19 -0700"
  },
  {
    organization_id: 1, title: "test 3", description: 'description', project_approval: 'approved', funding_status: 'not funded', shipping_status: 'pending', total_requested: 400, total_remaining: 400, total_donated: 0, organization_details: 'details', project_details: 'project_details', expires_on: "Tue, 26 Jan 2016 18:12:19 -0700"
  }
]
